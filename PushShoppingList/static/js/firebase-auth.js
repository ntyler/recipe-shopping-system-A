...
function hideAccountMenuPanels(exceptPanel = null) {
    document.querySelectorAll(
        "#userProfileEditForm, [data-account-notices-panel], [data-screen-settings-panel], [data-usage-dashboard-panel], [data-chatgpt-models-panel], [data-shared-recipe-pdfs-panel], [data-push-notifications-panel], [data-feedback-support-panel], [data-two-factor-panel], [data-delete-account-panel]"
    ).forEach((panel) => {
