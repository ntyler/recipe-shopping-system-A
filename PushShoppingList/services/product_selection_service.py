...
def test_grab_products(job_id=None):
    ...
    if job_id:
        ...
        update_product_progress_summary(
            job_id,
            "Test Grab: resolving the nearest ALDI from the fixed Arlo Drive address.",
        )
    ...
    if job_id:
        update_product_progress_summary(
            job_id,
            "Test Grab: opening ALDI with the nearest localized store selected, then searching eggs.",
        )
