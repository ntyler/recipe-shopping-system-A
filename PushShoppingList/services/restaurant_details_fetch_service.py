...
CURRENT_FIELD_KEYS = {
    ...
    "latitude": ("latitude", "restaurant_latitude"),
    "longitude": ("longitude", "restaurant_longitude"),
    ...
    "rating_count": ("rating_count", "restaurant_rating_count"),
    ...
    "rewards_promotions": ("rewards_text", "rewards_promotions", "restaurant_rewards_program", "restaurant_promotions"),
    "promotions": ("promotions", "restaurant_active_promotions"),
    "social_urls": ("social_urls", "restaurant_social_urls"),
