...
@pytest.mark.parametrize('script', ['meal_planner_editors.cjs', 'meal_calendar_drag.cjs', 'meal_planner_yield_split.cjs', 'meal_planner_shared_portions.cjs', 'meal_planner_recipe_portions.cjs', 'meal_planner_yield_coverage.cjs', 'meal_planner_upcoming_days.cjs'])
